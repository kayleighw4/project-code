...
# Times (in multiples of τ) at which to pause
pause_times = [0, 0.5, 1.0, 1.5]

# Convert pause times to frame numbers, given Δt = 0.005 seconds per frame
pause_frames = [int((t_tau * tau) / 0.005) for t_tau in pause_times]
...
# Animation
ani = FuncAnimation(fig, update, frames=100000, interval=500, blit=False)
plt.show()